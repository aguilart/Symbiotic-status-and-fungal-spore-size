...
AllFungi <- readRDS("AllFungi.RDS")
BirdEgg <- readRDS("BirdEgg.RDS")
FungalTaxanomy_col <- readRDS("FungalTaxanomy_col.RDS")
FunGuildData <- readRDS("FunGuildData.RDS")
kewData <- readRDS("kewData.RDS")
Li_tree_names <- readRDS("Li_tree_names.RDS")
Li_tree <- readRDS("Li_tree.RDS")
Spore_data <- readRDS("Spore_data.RDS")
Spore_functions <- readRDS("Spore_functions.RDS")
To_Analysis <- readRDS("Spore_functions.RDS")
...
Running the code below produces tables S3, S4 and S5.
...
```{r}
jpeg("Figures/Figure_1/Figure1_comparisons.jpeg",
     width = 1212, height = 560)
...
#   width = 16,
#    height = 19)
heatmap(datos1,Colv = NA, Rowv = NA,cexCol = 0.5,cexRow = 0.5, scale = "none", labRow = F, labCol = F, col=hcl.colors(12, "YlOrRd", rev = TRUE))
...
pdf("Figures/Figure_S2/Donut_plot_sporeType_phyla.pdf",
    width = 4.8,
    height = 8.4)  
...
pdf("Figures/Figure_S2/Donut_plot_sporeType_phyla_lowerF.pdf",
    width = 4.8,
    height = 8.4)  
...
pdf("Figures/Figure_S2/Donut_plot_sporeType_SporeName.pdf",
    width = 4.8,
    height = 8.4)  
...
pdf("Figures/Figure_S2/Donut_plot_sporeType_SporeName_Multi.pdf",
    width = 4.8,
    height = 8.4)    
...
```{r}
pdf("Figures/Figure_S3/FigureS3_bubbleplot.pdf",
    width = 23,
    height = 28)
cowplot::plot_grid(
...
pdf("Figures/Figure_S4/EL_FigureS4_bubbleplot.pdf",
    width = 23,
    height = 28)
cowplot::plot_grid(
